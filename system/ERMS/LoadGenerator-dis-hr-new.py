...
if __name__ == "__main__":
    ...
    if args.head:  # 主节点只负责下发请求,不运行负载生成器
        ...
        for i in range(args.node_size):
            cmd=" ssh {} 'ulimit -n 100000;cd /state/partition/jcshi/CJY/opentelemetry-microservices-demo/system/ERMS/;python3 LoadGenerator-dis-hr-new.py --head {} --qps {} --node_size {} -p {} -t {} -nodeName {} -d {} -host {}' "\
